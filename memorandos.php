...
<div class="page-header">
  ...
  <?php if ($action === 'list'): ?>
  <a href="?action=nuevo" class="btn-sithsa"><i class="fas fa-plus"></i> Nuevo Documento</a>
  <?php else: ?>
  <a href="memorandos.php" class="btn-sithsa-outline"><i class="fas fa-arrow-left"></i> Volver</a>
  <?php endif; ?>
</div>
...
<div class="card">
  <div class="card-body p-0">
    <table id="tbl-memo" class="table-sithsa w-100">
      <thead>
        <tr>
