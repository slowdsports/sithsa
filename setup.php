...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $step === 2) {
    ...
    $pass    = $_POST['db_pass'] ?? '';
    $db      = trim($_POST['db_name'] ?? 'sithsa_admin');
    ...
    try {
        ...
        $adminEmail = trim($_POST['admin_email'] ?? 'admin@sithsa.hn');
        $adminPass  = password_hash($_POST['admin_pass'] ?? 'Admin2024!', PASSWORD_BCRYPT);
        $adminName  = trim($_POST['admin_name'] ?? 'Administrador SITHSA');
...
<title>SITHSA - Instalación del Sistema</title>
...
<div class="container py-5" style="max-width:680px">
  <div class="text-center mb-4">
    <img src="<?= BASE_URL ?>assets/images/logo2aa.png" alt="SITHSA" style="height:60px;margin-bottom:1rem;">
    <h3 style="color:#0D2B4E">Instalación del Sistema</h3>
    <p class="text-muted">SITHSA — Sistema de Administración y Finanzas</p>
  </div>
    ...
    <div class="card-body">
      ...
      <form method="POST">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6"><label class="form-label">Nombre de la Base de Datos</label><input name="db_name" class="form-control" value="sithsa_admin" required></div>
        ...
        <div class="row g-3">
          <div class="col-12"><label class="form-label">Nombre completo</label><input name="admin_name" class="form-control" value="Administrador SITHSA" required></div>
          <div class="col-md-6"><label class="form-label">Correo electrónico</label><input type="email" name="admin_email" class="form-control" value="admin@sithsa.hn" required></div>
        ...
        <button type="submit" class="btn-sithsa w-100 mt-2" style="padding:.65rem"><i class="fas fa-database"></i> Instalar Sistema</button>
      </form>
    </div>
  </div>
  ...
  <div class="card shadow border-success">
    <div class="card-body text-center py-5">
      ...
      <p>El sistema SITHSA ha sido instalado correctamente.</p>
      ...
      <a href="<?= BASE_URL ?>index.php" class="btn-sithsa" style="padding:.65rem 1.5rem;">
